...
Galaxy Watch 기반 생체 데이터(baseline, anomalies)

사용자 정보(age, gender, job 등)
...
실제 상담 데이터를 참고해 현실적·안전한 조언 제공

✔️ 개인용 주간 조언 (private_advice)

주간 보고서 + 유사 상담 기록을 기반으로

100~300자 사이의 현실적, 따뜻한 조언
...
조언이 RAGAS 평가 기준 점수 0.7 이상일 때만 저장
